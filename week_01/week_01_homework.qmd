...
Probability review. The table presents the joint distribution for two variables: country of origin and whether a runner ended up in the top 10. Compute the following (don’t just show the final result, show how you arrived at it):
